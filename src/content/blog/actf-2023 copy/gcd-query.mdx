...
翻山倒海匡扶汉室豆腐砂代发哈师大 asdfhishdfiashfioashod 阿发收到货发收到货覅拉沙啊收到货覅是覅是否啊好的是覅撒活动覅手动阀 阿斯蒂芬his啊好覅阿是分啊收到货覅u啊是覅四大护法阿斯三大法宝换行符黄河壶口三大男手机卡年级红红火火恍恍惚惚黑胡椒好几回
...
<InfoBox>
  **Chinese Remainder Theorem**: Given pairwise coprime integers $$n_1, n_2,
  \ldots, n_k$$ and arbitrary integers $$a_1, a_2, \ldots, a_k$$, the system of
  simultaneous congruences $$ \begin{cases}x &\equiv a_1 \pmod{n_1} \\ x &\equiv
  a_2 \pmod{n_2} \\ \vdots \\ x &\equiv a_k \pmod{n_k}
  \end{cases}
  $$ has a solution, and the solution is unique modulo $$N = n_1 n_2 \cdots
  n_k$$.
</InfoBox>
